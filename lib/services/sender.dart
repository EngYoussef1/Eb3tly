...
import 'package:Eb3tly/models/file_model.dart';
import 'package:Eb3tly/models/sender_model.dart';
import 'package:Eb3tly/models/share_error_model.dart';
...
class Eb3tlySender {
      ...
      (HttpRequest request) async {
        if (request.requestedUri.toString() ==
          ...
          if (int.parse(requriToList[requriToList.length - 2]) ==
            ...
            request.response
                .write('Wrong secret-code.3b2tly-server denied access');
            request.response.close();
  ...
  static Future<Map<String, dynamic>> share(
    ...
    if (externalIntent) {
      ...
      // 3b2tly will be opened along with intended files' paths.
